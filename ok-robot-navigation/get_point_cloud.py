...
parser.add_argument("--output_file", default='pointcloud.ply', help="Path to the outputed ply file")

# Parse the arguments
args = parser.parse_args()

assert args.output_file[-4:]=='.ply', "The output file needs to be a ply file, which means the file name needs to end in .ply"
...
get_pointcloud(get_posed_rgbd_dataset(key = 'r3d', path = args.input_file), args.output_file)
