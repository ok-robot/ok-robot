...
parser.add_argument('--max_gripper_width', type=float, default=0.05, help='Maximum gripper width (<=0.1m)')
...
parser.add_argument('--sampling_rate', type=float, default = 0.2, help='Sampling rate of points [<= 1]')
